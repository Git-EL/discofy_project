...
function Contact ()  {
  ...
  return (
   ...
   <div className="big-container">
    <div className='Card'>
      <div className='upper-container'>
        ...
        <img src="https://avatars.githubusercontent.com/u/65951047?s=400&u=b8b905ad11fc8a6e213014149407099b5e5dc978&v=4" alt ='' height="100px" width="100px" />
   ...
   <div className='Card-2'>
      <div className='upper-container'>
        <div className='image-container'>
        <img src="https://media-exp1.licdn.com/dms/image/C4E35AQFWgoJeYA-J_g/profile-framedphoto-shrink_800_800/0/1616377997019?e=1619769600&v=beta&t=HQ0Ow5Yjv7WUXbYnLTiZZlk10Ce_diqpd3jKeUCSohQ" alt ='' height="100px" width="100px" />
   ...
   <div className="ft-social">
     ...
     <li><a href="https://www.linkedin.com/in/esther-lee-627451205/"><i className="fab fa-linkedin"></i></a></li>
      ...
      <button className="home-button">
        <Link to='/' className="home-first"> Back to Home
        </Link>
